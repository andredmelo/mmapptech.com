...
interface MMAPPWelcomeEmailProps {
  steps?: {
    id: number;
...
const PropDefaults: MMAPPWelcomeEmailProps = {
  steps: [
    {
      id: 1,
      Description: (
    ...
    },
    {
      ...
      Description: (
        <li className="mb-20" key={4}>
          ...
          and buy it through MMAPP or assign a domain you already own to your
...
export const MMAPPWelcomeEmail = ({
  steps = PropDefaults.steps,
  links = PropDefaults.links,
}: MMAPPWelcomeEmailProps) => {
  return (
    <Html>
      <Head />
      <Preview>MMAPP Welcome</Preview>
      <Tailwind
        config={{
          theme: {
            extend: {
      ...
      >
        <Body className="bg-offwhite text-base font-sans">
          <Img
            src={`${baseUrl}/static/mmapp-logo.png`}
            width="184"
            height="75"
            alt="MMAPP"
            ...
            <Section>
              <Row>
                <Text className="text-base">
                  ...
                  around the world who use MMAPP to build and ship sites,
                  stores, and apps.
                </Text>
          ...
          <Container className="mt-20">
            ...
            <Text className="text-center text-gray-400 mb-45">
              MMAPP, 44 Montgomery Street, Suite 300 San Francisco, CA
            </Text>
          </Container>
        </Body>
      </Tailwind>
...
export default MMAPPWelcomeEmail;
