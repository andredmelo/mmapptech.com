...
const Benefits = (/* props: BenefitsProps */) => {
  ...
  return (
    <>
      <div className='flex flex-col md:flex-row justify-center md:min-h-[91rem] lg:min-h-[83rem] xl:min-h-[73rem] 2xl:min-h-[69rem] portrait:lg:min-h-[97rem] portrait:touch:md:min-h-[86.5rem] max-w-[1450px] mx-1 md:mx-[1rem] xl:mx-[8rem] 2xl:mx-[10rem]'>  {/* 3xl:min-w-[1536px] 3xl:mx-auto */}
