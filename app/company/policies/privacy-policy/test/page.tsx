...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <section id="PrivacyPolicy" className="w-full h-full bg-[var(--background-grey)]">
        <div className="flex flex-col w-full">
          ...
          <p>Questions or concerns? Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at privacy@mmapptech.com.</p>
          <p><br /><br /></p>
          ...
          <p>How do you exercise your rights? The easiest way to exercise your rights is by visiting https://dashboard.mmapp.app, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</p>
          ...
          <p>In order to officialize the outcome of competitions</p>
          <p>__________</p>
          ...
          <p>If you have questions or comments about your privacy rights, you may email us at privacy@mmapptech.com.</p>
          <ol>
          <li>CONTROLS FOR DO-NOT-TRACK FEATURES</li>
          </ol>
          ...
          <p>In Short: If you are a resident of California, Colorado, Connecticut, Virginia or Utah, you are granted specific rights regarding access to your personal information.</p>
          <p>What categories of personal information do we collect?</p>
          <p>We have collected the following categories of personal information in the past twelve (12) months:</p>
          <p>CategoryExamplesCollected</p>
          <ol>
          <li>Identifiers</li>
          </ol>
          ...
          <p>YES</p>
          <ol>
          <li>Personal information as defined in the California Customer Records statute</li>
          </ol>
          ...
          <p>NO</p>
          <ol>
          <li>Sensitive personal InformationState ID card numbers, personal data from a known child, passport numbers, account login information, biometric data and citizenship or immigration status</li>
          </ol>
          <p>YES</p>
          <p><br /><br /></p>
          ...
          <p>To exercise your right to limit use and disclosure of sensitive personal information, please email privacy@mmapptech.com or visit: https://dashboard.mmapp.app.</p>
          ...
          <p>To exercise these rights, you can contact us by visiting https://dashboard.mmapp.app, by email at privacy@mmapptech.com, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</p>
          ...
          <p>If you have questions or comments about this notice, you may email us at privacy@mmapptech.com or contact us by post at:</p>
          <p>MMAPP Technologies, Unipessoal Lda.</p>
          <p>Avenida da Rep&uacute;blica, 861, Bloco D, 3&ordm; Dto.</p>
          <p>Bloco D, 3&ordm; Dto.</p>
          <p>Parede, Lisbon 2775-274</p>
          <p>Portugal</p>
          <ol>
          <li>HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</li>
          </ol>
          <p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please visit: https://dashboard.mmapp.app.</p>
        </div>
      </section>
    </>
  )
