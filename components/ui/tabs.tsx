...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ...
    className={cn(
      ...
      "mt-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 ring-offset-gray-950 focus-visible:ring-gray-300",
      className
    )}
    {...props}
  />
